...
const CreatePerformanceRating = () => {
  ...
  const getAllEmployees = async (selectedDemand) => {
    try {
                  ...
                  <MDBox display="flex" width="100%">
                    ...
                    >
                      <FormControl fullWidth margin="normal">
                        ...
                        <RadioGroup row onChange={handleEstimationChange}>
                    ...
                    >
                      <FormControl fullWidth margin="normal">
                        ...
                        <RadioGroup row onChange={handleAutonomyChange}>
                          <FormControlLabel value={0} control={<Radio />} label="Non compliant" />
                    ...
                    <MDBox display="flex" width="100%">
                      ...
                      >
                        <FormControl fullWidth margin="normal">
                          ...
                          <RadioGroup row onChange={handleOptimizationChange}>
                            <FormControlLabel value={0} control={<Radio />} label="Non compliant" />
                            <FormControlLabel value={3} control={<Radio />} label="Compliant" />
                            <FormControlLabel
                              value={5}
                      ...
                      >
                        <FormControl fullWidth margin="normal">
                          ...
                          <RadioGroup row onChange={handlePerfermanceChange}>
                            <FormControlLabel value={0} control={<Radio />} label="Non compliant" />
                            <FormControlLabel value={3} control={<Radio />} label="Compliant" />
                            <FormControlLabel
                              value={5}
                    ...
                    <MDBox display="flex" width="100%">
                      ...
                      >
                        <FormControl fullWidth margin="normal">
                          ...
                          <RadioGroup row onChange={handleCommentedCodeChange}>
                            <FormControlLabel value={0} control={<Radio />} label="Non compliant" />
                            <FormControlLabel value={3} control={<Radio />} label="Compliant" />
                            <FormControlLabel
                              value={5}
                      ...
                      >
                        <FormControl fullWidth margin="normal">
                          ...
                          <RadioGroup row onChange={handleTranslationChange}>
                            <FormControlLabel value={0} control={<Radio />} label="Non compliant" />
                            <FormControlLabel value={3} control={<Radio />} label="Compliant" />
                            <FormControlLabel
                              value={5}
