...
const UpdatePsychotechnicalReport = () => {
  ...
  useEffect(() => {
    if (location.state.rowData) {
      ...
      setAttendanceFrequency(attendanceFrequency);
      setPunctuality(punctuality);
      setAbsenceCommunication(absenceCommunication);
      setTotalAttendance(TotalAttendance);
      setInterpersonalRelationships(interpersonalRelationships);
      setCollaboration(collaboration);
      setInterpersonalTotal(InterpersonalTotal);
      setTechEvalRating(TechEvalRating);
      setTechEvaltoatal(TechEvaltoatal);
      setTotal(total);
  ...
  const handleSubmit = async () => {
    try {
      if (
        ...
        absenceCommunication === undefined ||
        interpersonalRelationships === undefined ||
        collaboration === undefined ||
        TechEvalRating === undefined
      ) {
        setError("All fields are required.");
        return;
      }
      await axios.put(
        `psychotechnical-report/${Id}`,
        {
          Id,
          created_At,
          attendanceFrequency,
                  ...
                  <MDBox display="flex" width="100%">
                    ...
                    >
                      <FormControl fullWidth margin="normal">
                        ...
                        <RadioGroup
                          ...
                          onChange={handleAttendanceFrequencyChange}
                        >
                    ...
                    >
                      <FormControl fullWidth margin="normal">
                        ...
                        <RadioGroup row value={punctuality} onChange={handlePunctualityChange}>
                          <FormControlLabel value={0} control={<Radio />} label="Non compliant" />
                          <FormControlLabel value={3} control={<Radio />} label="Compliant" />
                          <FormControlLabel value={5} control={<Radio />} label="Super compliant" />
                        </RadioGroup>
                  ...
                  <MDBox display="flex" width="100%">
                    ...
                    >
                      <FormControl fullWidth margin="normal">
                        ...
                        <RadioGroup
                          row
                          value={absenceCommunication}
                          onChange={handleAbsenceCommunicationChange}
                        >
                          <FormControlLabel value={0} control={<Radio />} label="Non compliant" />
                          <FormControlLabel value={3} control={<Radio />} label="Compliant" />
                          <FormControlLabel value={5} control={<Radio />} label="Super compliant" />
                    ...
                    >
                      <FormControl fullWidth margin="normal">
                        ...
                        <RadioGroup
                          row
                          onChange={handleInterpersonalRelationshipsChange}
                  ...
                  <MDBox display="flex" width="100%">
                    ...
                    >
                      <FormControl fullWidth margin="normal">
                        ...
                        <RadioGroup row onChange={handleCollaborationChange} value={collaboration}>
                          <FormControlLabel value={0} control={<Radio />} label="Non compliant" />
                          <FormControlLabel value={3} control={<Radio />} label="Compliant" />
                          <FormControlLabel value={5} control={<Radio />} label="Super compliant" />
                        </RadioGroup>
                    ...
                    >
                      <FormControl fullWidth margin="normal">
                        ...
                        <RadioGroup
                          row
                          value={TechEvalRating}
                          onChange={handleTechEvalRatingChange}
                        >
                          <FormControlLabel value={0} control={<Radio />} label="Non compliant" />
                          <FormControlLabel value={3} control={<Radio />} label="Compliant" />
                          <FormControlLabel value={5} control={<Radio />} label="Super compliant" />
...
export default UpdatePsychotechnicalReport;
